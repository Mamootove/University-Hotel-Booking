...
│   └─ <city>.txt     # Room and reservation info for each city | There are several city files
│
...
Since we are using pickle to store files, be careful not to modify the data files.
---
